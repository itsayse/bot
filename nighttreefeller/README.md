...
2. **One-chop tree felling** — break the *bottom* log of a tree and the whole
   ...
   middle of a trunk still just breaks that single block, like vanilla. The
   leaf canopy fast-decays once it loses all log support, no matter what order
   you chop the trunk in.
